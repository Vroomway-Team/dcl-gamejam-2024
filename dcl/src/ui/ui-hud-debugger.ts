...
import { doLoginFlow, fetchLeaderboardInfo, logout, refreshUserData, resetLoginState } from '../connect/login-flow'
...
import { disconnect } from '../connect/connection'
...
const buttonWidth = 121 //+ 100
const changeButtonWidth = 120
const changeButtonHeight = 16//*3
...
function updateDebugButtonUI(testButton: PromptButton) {
    ...
    //testButton.labelElement.uiTransform!.height = changeButtonHeight
    ...
    const enableDisableToggle = testButton = testControlsToggle.addButton(
        {
            ...
            text: 'show:false',
            xPosition: buttonPosCounter + (buttonWidth*5),
