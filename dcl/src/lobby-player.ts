import { Dictionary, List } from "./escentials";
...
export module LobbyPlayer {
    ...
    export function Create(data:PlayerDataDefinition) {
        ...
        VehicleManager.UpdateVehicleStateByID(data.Vehicle, true);
    ...
    export function Destroy(target:string) {
        ...
        //update claimed vehicle state
        VehicleManager.UpdateVehicleStateByID(playerData.Vehicle, false);
