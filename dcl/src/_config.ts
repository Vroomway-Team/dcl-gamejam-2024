...
export class Config {
	public CURRENT_VERSION      : string  = "20240625a" //Current data in YYYYMMDD format. Optional alphabetical suffix can be added for multiple deployments on the same date. Eg: 20240624b
